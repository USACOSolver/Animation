...
TextureMapping::TextureMapping()
{
	...
	_sphere->scale = glm::vec3(0.2f, 0.2f, 0.2f);
	...
	_camera.reset(new Camera(glm::vec3(0, 0, 10)));
	// init light
...
void TextureMapping::renderFrame()
{
	...
	const glm::mat4 &projection = glm::perspective(glm::radians(_camera->Zoom), (float)_windowWidth / (float)_windowHeight, 0.1f, 100.0f);
	const glm::mat4 &view = _camera->GetViewMatrix();
